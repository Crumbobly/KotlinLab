...
import ru.lab1.web.handlers.userHandlers.ListUsersHandler

class ListUsersHandlerTest : FunSpec({

    val handlerData = HandlerData()
    val routes =
        routes(
            "/users" bind Method.GET to ListUsersHandler(handlerData.htmlView, handlerData.db::getAllUsers),
        )
